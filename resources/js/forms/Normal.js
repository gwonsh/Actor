Ext.define('resources.js.forms.Normal', {
	singleton : true,
	CLASSNAME:'Normal',
	getName:function(){
		return loc.viewer.normalView;
	},
	...
	setHtml:function(values, viewer){
		...
		html += '	<span class="label-left-space">'+viewer.title+'<span></div>';
		/* basic info */
		html +=	'	<div style="width:100%">';
		html +=	'		<table border=1 cellpadding=0 cellspacing=0 class="viewer-table section-space" style="font-size: 12px">';
		var subject = values.bd_subject;
		if(subject === undefined) subject = ' ';
		html +=	'			<tr>';
		html +=	'				<th height="25" '+subjectAttr+' colspan=6>'+subject+'</th>';
		html +=	'			</tr>';
		html +=	'			<tr>';
		...
		html +=	'				<th>Data ID</th>';
		html +=	'				<td>'+values.bd_idx+'</td>';
		html +=	'			</tr>';
		var remark = values.bd_content;
		if(remark === undefined) remark = '';
		html +=	'			<tr>';
		html +=	'				<td height="25" '+contentAttr+' colspan=6>'+remark+'</td>';
		html +=	'			</tr>';
		html +=	'		</table>';
		html +=	'	</div>';
		/* custom fields */
		...
		html += '	<table border=1 cellpadding=0 cellspacing=0 class="viewer-table section-space">';
		html += '		<tr><th>'+values.originalCategoryName +' '+loc.main.attachFile+'</th></tr>';
		html += '		<tr>';
		html +=	'			<td>';
		html += '				<div style="width:100%">';

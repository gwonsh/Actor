...
Ext.define('Actor.controller.Post', {
    ...
    */
    showNewPost: function(target, pluginName, colsList) {
        if(!target){
    ...
    editPost: function(serverData, title, target, pluginName) {
    ...
    /*  */
    setCustomFields: function(colsList, target, isEditMode) {
        var me = this;
        var i, j;
    ...
    onPickfilesAfterRender: function(component) {
    ...
    setDatasetField: function(entry, isEditMode, target) {
        var i, j;
        var me = this;
        var colsIdx = entry.cols_idx.toString();
    ...
    getDatasetGridColumns: function(colsInfo) {
    ...
    delAttachedFile: function(div, formId) {
    ...
    resetUploadForm: function(window) {
    ...
    showUploadStatus: function(win, submit) {
        var me = this;
    ...
    setLikedCategory: function(field) {
    ...
    submitMember: function(win, record, item) {
